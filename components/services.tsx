  ...
  const services = [
    {
      ...
      description: "Building responsive, interactive user interfaces using React.js, Next.js, and modern CSS frameworks."
    },
    {
      icon: <Server className="h-10 w-10 text-primary" />,
      title: "Backend Development",
      description: "Creating robust server-side applications with Node.js, Express.js, and RESTful API design."
    },
    {
      icon: <Database className="h-10 w-10 text-primary" />,
      title: "Database Design",
      description: "Designing efficient and scalable database schemas using MongoDB and implementing with Mongoose."
    },
    {
      icon: <Code2 className="h-10 w-10 text-primary" />,
      title: "Full Stack Development",
      description: "End-to-end application development from frontend to backend using the complete MERN stack."
    },
    {
      ...
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-lg text-muted-foreground">
            Specialized web development services tailored to meet your specific needs and requirements.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, i) => (
            ...
            >
              <Card className="h-full border-2 hover:border-primary hover:shadow-lg transition-all duration-300 group">
          ...
          <div className="relative z-10">
            <div className="flex flex-col lg:flex-row gap-8 items-center">
              <div className="flex-1">
                <h3 className="text-2xl font-bold mb-4">Need a custom web application?</h3>
                <p className="text-muted-foreground mb-6">
                  Let's discuss your project requirements and how I can help bring your ideas to life. 
                  I'm dedicated to delivering high-quality solutions tailored to your specific needs.
                </p>
